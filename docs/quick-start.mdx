...
- Keep both values handy.
  <img src={useBaseUrl('/img/vap.jpg')}
...
5. Click on **'Show Private Key'** button to verify the private key.
  ...
  <img src={useBaseUrl('/img/set.jpg')}
...
- On your Backend Workflow click on 'vapi_webhook' 
  ...
  <img src={useBaseUrl('/img/webhook.jpg')}
 ...
 Then click on 'Detect Data'
  ...
  <img src={useBaseUrl('/img/webhook-init.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
     style= {{
      width: '100%',
      maxWidth: '100%',
...
- Linking your assistant to the Bubble webhook is like plugging your phone into the wall—it lets every call event flow instantly into your app. This real-time connection powers live logs, transcripts, and dashboards so you never miss a single ring. 
  ...
  <img src={useBaseUrl('/img/vapi.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
  class="zoomable"
     style= {{
      width: '100%',
...
<img src={useBaseUrl('/img/create-assistant.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
  class="zoomable"
     style= {{
      width: 'auto',
...
<img src={useBaseUrl('/img/vapi01.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
  class="zoomable"
     style= {{
      width: 'auto',
...
<img src={useBaseUrl('/img/vapi02.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
  class="zoomable"
     style= {{
      width: 'auto',
...
1. In Vapi: **Phone Numbers → Create Phone Number** (or **BYO**)  
  ...
  <img src={useBaseUrl('/img/phone.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
3. You’ll see it under **Home → Phone Numbers**.
  ...
  <img src={useBaseUrl('/img/vapi03.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
## 3. Now you have an Assistant with your webhook app URL attached and your phone number
  ...
  <img src={useBaseUrl('/img/vapi04.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
3. Click **Call Now**. 
  ...
  <img src={useBaseUrl('/img/vapi05.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
4. Your call must be see in Section **Call** > **Application Call**.
  ...
  <img src={useBaseUrl('/img/vapi06.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
5. Very on your database (Data > App data > All Calls) you must see the call informations.
  ...
  <img src={useBaseUrl('/img/vapi07.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
...
2. Remove the initialise at the end of the URL > **/initialize** (strictly).
  ...
  <img src={useBaseUrl('/img/vapi08.jpg')}
  alt = "Smart-Reception Dashboard screenshot"
   class="zoomable"
     style= {{
      width: 'auto',
